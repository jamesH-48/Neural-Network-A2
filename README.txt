...
- Preprocessing is done to alter the classification output. Originally the dataset gives the output as L, B, R (left, balanced, right). This is changed into a 3 output system where (1,0,0) = L, (0,1,0) = B, & (0,0,1) = R.
- Link to Dataset: https://archive.ics.uci.edu/ml/datasets/Balance+Scale
------------------------------------------------------------------------------------------------------------------------------------
Libraries Used:
import numpy as np
import pandas as pd
